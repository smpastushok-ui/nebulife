...
export const ELEMENTS: Record<string, Element> = {
  ...
  Li: { symbol: 'Li', name: 'Lithium',    atomicNumber: 3,  atomicMass: 6.941,   category: 'metal' },
  Be: { symbol: 'Be', name: 'Beryllium',  atomicNumber: 4,  atomicMass: 9.012,   category: 'metal' },
  ...
  F:  { symbol: 'F',  name: 'Fluorine',   atomicNumber: 9,  atomicMass: 18.998,  category: 'nonmetal' },
  Ne: { symbol: 'Ne', name: 'Neon',       atomicNumber: 10, atomicMass: 20.180,  category: 'noble-gas' },
  ...
  Cl: { symbol: 'Cl', name: 'Chlorine',   atomicNumber: 17, atomicMass: 35.450,  category: 'nonmetal' },
  ...
  V:  { symbol: 'V',  name: 'Vanadium',   atomicNumber: 23, atomicMass: 50.942,  category: 'metal' },
  Cr: { symbol: 'Cr', name: 'Chromium',   atomicNumber: 24, atomicMass: 51.996,  category: 'metal' },
  Mn: { symbol: 'Mn', name: 'Manganese',  atomicNumber: 25, atomicMass: 54.938,  category: 'metal' },
  Fe: { symbol: 'Fe', name: 'Iron',       atomicNumber: 26, atomicMass: 55.845,  category: 'metal' },
  Co: { symbol: 'Co', name: 'Cobalt',     atomicNumber: 27, atomicMass: 58.933,  category: 'metal' },
  ...
  Se: { symbol: 'Se', name: 'Selenium',   atomicNumber: 34, atomicMass: 78.971,  category: 'nonmetal' },
  Kr: { symbol: 'Kr', name: 'Krypton',    atomicNumber: 36, atomicMass: 83.798,  category: 'noble-gas' },
  Sr: { symbol: 'Sr', name: 'Strontium',  atomicNumber: 38, atomicMass: 87.620,  category: 'metal' },
  Ag: { symbol: 'Ag', name: 'Silver',     atomicNumber: 47, atomicMass: 107.87,  category: 'metal' },
  Sn: { symbol: 'Sn', name: 'Tin',        atomicNumber: 50, atomicMass: 118.71,  category: 'metal' },
  Xe: { symbol: 'Xe', name: 'Xenon',      atomicNumber: 54, atomicMass: 131.29,  category: 'noble-gas' },
  Ba: { symbol: 'Ba', name: 'Barium',     atomicNumber: 56, atomicMass: 137.33,  category: 'metal' },
  W:  { symbol: 'W',  name: 'Tungsten',   atomicNumber: 74, atomicMass: 183.84,  category: 'metal' },
  Pt: { symbol: 'Pt', name: 'Platinum',   atomicNumber: 78, atomicMass: 195.08,  category: 'metal' },
  Au: { symbol: 'Au', name: 'Gold',       atomicNumber: 79, atomicMass: 196.97,  category: 'metal' },
  Ra: { symbol: 'Ra', name: 'Radium',     atomicNumber: 88, atomicMass: 226.03,  category: 'metal' },
  Th: { symbol: 'Th', name: 'Thorium',    atomicNumber: 90, atomicMass: 232.04,  category: 'metal' },
  U:  { symbol: 'U',  name: 'Uranium',    atomicNumber: 92, atomicMass: 238.029, category: 'metal' },
  Pu: { symbol: 'Pu', name: 'Plutonium',  atomicNumber: 94, atomicMass: 244.06,  category: 'metal' },
};
