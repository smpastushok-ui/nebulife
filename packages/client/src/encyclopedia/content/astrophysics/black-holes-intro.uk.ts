...
const lesson: Lesson = {
  ...
  <text x="320" y="16" fill="#aabbcc" font-family="monospace" font-size="12" text-anchor="middle">R_s = 2GM / c²</text>
        ...
        caption:
          'R_s = 2GM/c². Для маси Сонця це ~3 км. Для M87* — 38 мільярдів км (більше орбіти Нептуна). ' +
  ...
  <defs>
...

    {
      ...
      paragraphs: [
        ...
        'Планківські масштаби (~10⁻³⁵ м). Теорія струн і петльова квантова гравітація — ' +
...

    {
      image: {
        ...
        caption: 'Випромінювання Гокінга настільки слабке, що для чорної діри зоряної маси його температура (~60 нанокельвінів) нижча за температуру реліктового випромінювання. Спостерігати його прямо зараз неможливо.',
        aspectRatio: '4:3',
      },
    },
  ],
  ...
  glossary: [
    ...
    },
    {
      ...
      definition:
        'Радіус горизонту подій для невобертної чорної діри (рішення Шварцшильда ЗТВ). R_s = 2GM/c². Для Сонця — ~3 км.',
    },
    {
