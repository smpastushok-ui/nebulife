...
const lesson: Lesson = {
  ...
  glossary: [
    ...
    },
    {
      ...
      definition:
        'Теплове мікрохвильове випромінювання, що рівномірно заповнює Всесвіт — залишок фотонів, що вирвалися під час рекомбінації через 380 000 р. після Великого вибуху. Температура 2,725 K.',
    },
    {
      term: 'Рекомбінація',
      definition:
        'Момент в ранньому Всесвіті (~380 000 р.), коли температура впала до ~3000 K і вільні електрони приєдналися до ядер, утворивши нейтральні атоми. Всесвіт став прозорим для фотонів.',
    },
    {
      term: 'Інфляція',
      definition:
        'Гіпотетичний надшвидкий етап розширення Всесвіту одразу після Великого вибуху (~10⁻³² с), що пояснює однорідність КМФ і геометричну плоскість Всесвіту.',
    },
    {
      term: 'Нуклеосинтез епохи Великого вибуху (BBN)',
      definition:
        'Ядерні реакції в перші три хвилини Всесвіту, що сформували первинні пропорції водню (~75%) і гелію-4 (~25%).',
    },
    {
