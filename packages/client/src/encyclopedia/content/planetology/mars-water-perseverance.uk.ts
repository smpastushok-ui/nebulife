...
const lesson: Lesson = {
  ...
  body: [
...

    {
      ...
      paragraphs: [
        ...
        'Планета майже вдвічі менша за Землю: діаметр 6 779 км проти 12 742 кілометрів Рік на Марсі — 687 земних доби, ' +
...

    {
      image: {
        ...
        caption: 'Повний диск Марса з видимими геологічними структурами: вулкан Олімп заввишки 21 км і каньйон Долина Марінер завдовжки 4 000 кілометрів',
        aspectRatio: '1:1',
      },
    },
...

    {
      ...
      paragraphs: [
        ...
        'Передбачуваний підземний резервуар розташований на глибині близько 1,5 км і простягається на 20 × 30 кілометрів',
...

    {
      ...
      paragraphs: [
        ...
        'технологічна демонстрація масою 1,8 кілограмів ' +
  ...
  <text x="350" y="42" text-anchor="middle" fill="#cc4444" font-family="monospace" font-size="10">Статус: фінансування США скасоване (01.2026). Архітектура переглядається.</text>
...

    {
      image: {
        ...
        caption: 'Марс у 2026 році: шість апаратів на орбіті та два ровери на поверхні. Найбільше одночасне наукове охоплення в історії вивчення Червоної планети.',
        aspectRatio: '4:3',
      },
    },
  ...
  glossary: [
    ...
    {
      term: 'MARSIS',
      definition: 'Mars Advanced Radar for Subsurface and Ionosphere Sounding — радарний прилад зондування підповерхневих шарів і іоносфери на борту орбітера ESA Mars Express. У 2018 та 2020 роках виявив сигнали, інтерпретовані як підземні озера під південним полюсом Марса.',
    },
    {
  ...
  quiz: [
    ...
    },
    {
      ...
      correctIndex: 2,
      explanation: 'Ingenuity завершив 72 польоти замість запланованих п\'яти. Місія завершилась у січні 2024 році через пошкодження ротора при посадці.',
    },
    {
      ...
      correctIndex: 2,
      explanation: 'У січні 2026 році Конгрес США затвердив бюджет, що фактично позбавив MSR фінансування. ESA скасувало розробку ERO. Альтернативні варіанти обговорюються, але шлях до реалізації незрозумілий.',
    },
    {
