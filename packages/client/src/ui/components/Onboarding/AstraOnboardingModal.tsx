...
//
// Layout follows the existing unlock-popup card (App.tsx) with the ASTRA
// hologram video block from TutorialOverlay on top. Voiceover clip
// (public/sfx/onboarding/<key>_<lang>.mp3|webm) autoplays when present and
// fails silently when the file is missing or autoplay is blocked.
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ASTRA hologram video */}
        <div
          style={{
            position: 'relative',
            height: isCompact ? 108 : 148,
            margin: '0 auto 14px',
            borderRadius: 6,
            overflow: 'hidden',
