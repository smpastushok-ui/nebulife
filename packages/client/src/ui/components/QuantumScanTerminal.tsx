...
const MODEL_MESSAGES = [
  ...
  '[VERT] Побудова вершинної сiтки...',
  '[TEX] Картографування текстур поверхнi...',
  ...
  '[CLOUD] Реконструкцiя хмарного шару...',
  '[RING] Перевiрка кiлець i супутникiв...',
  '[PROC] Фiналiзацiя голограми...',
  '[PACK] Компресiя даних...',
  '[VALID] Верифiкацiя структури...',
];
