...
function MenuItem({ label, onClick }: { label: string; onClick: () => void }) {
  ...
  return (
    <button
      style={{ ...itemStyle, background: hover ? itemHoverBg : 'none' }}
...
export function PlanetContextMenu({ planet, screenPosition, onViewPlanet, onShowCharacteristics, onClose }: {
  planet: Planet;
  ...
  return (
    <>
      ...
      <div style={{ ...menuStyle, left, top }}>
        ...
        <MenuItem label="Дивитися" onClick={onViewPlanet} />
